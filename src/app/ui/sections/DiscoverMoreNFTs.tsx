...
const NFTCard = ()=>{
    return <address className='flex
        ...
        />
        <div className='grid gap-6 px-7 py-5 bg-[var(--background---secondary)]'>
            <div className='grid gap-1'>
                <h3 className='font-second font-semibold text-(var(--text))'>Life on Edena</h3>
                <Author addClass={''}/>
            </div>
    ...
    return (
        ...
        '>
            ...
            <a href='#' type={'button'}
               ...
               md:px-12 py-5 font-semibold font-second text-base'  aria-label="">
