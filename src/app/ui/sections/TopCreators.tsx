...
const Author = ()=>{
    return <address className='flex p-5
                 gap-5
                 lg:flex-col
                lg:justify-center
        ...
        <div className='flex justify-center relative'>
            <p className='w-[30px] h-[30px] bg-[var(--background)]
                        text-base text-center text-[var(--caption-label-text)]
            ...
            <div className='
                        ...
                        '>
                <Image width={60} height={60} loading={'lazy'}
                       src={NoPhone}
                       alt={''}
                       className='
                                    object-contain
        ...
        <div className='grid gap-0.5'>
            ...
            <p className='
                    font-normal font-second text-[var(--caption-label-text)]
                    lg:text-center
                    '> Total Sales: <span
                className='font-main font-normal  text-base uppercase text-[var(--text)]'
            >34.53 ETH</span></p>
        </div>
